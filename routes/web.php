...
Route::middleware('auth')->group(function () {
    ...
    Route::get('employee', [\App\Http\Controllers\employeecontroller::class, 'index']);
    Route::put('employee/create', [App\Http\Controllers\employeecontroller::class, 'create'])->name('employee.create');
    Route::put('employee', [App\Http\Controllers\employeecontroller::class, 'store'])->name('employee.edit');
